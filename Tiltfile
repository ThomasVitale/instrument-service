SOURCE_IMAGE = os.getenv("SOURCE_IMAGE", default='ghcr.io/thomasvitale/instrument-service-source')
...
k8s_custom_deploy(
    ...
    apply_cmd="tanzu apps workload apply -f config/workload.yml --debug --live-update" +
               ...
               " && kubectl get workload instrument --namespace " + NAMESPACE + " -o yaml",
...
k8s_resource('instrument', port_forwards=["8080:8080"],
            extra_pod_selectors=[{'serving.knative.dev/service': 'instrument'}])
